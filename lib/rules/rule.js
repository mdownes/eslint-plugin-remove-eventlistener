    ...
    create: function (context) {
        ...
        function getEventName(event) {
            ...
            if (event.type === "Literal") {
                ...
                console.log(event.object.name + "." + event.property.name)
        ...
        function addEventListener(node) {
            ...
            if (handler &&
                ...
                const key = `${element}_${getEventName(event)}_${handlerName || "handler"}`;
        ...
        function removeEventListener(node) {
            ...
            if (
                ...
                let handlerName = getHandlerName(handler);
                const element = getElementName(node);
                const key = `${element}_${getEventName(event)}_${handlerName}`;
